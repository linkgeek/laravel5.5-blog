        ...
        <div class="animate form login_form">
            <section class="login_content">
                <form action="{{ url('auth/admin/login') }}" method="post">
                    ...
                    <div>
                        <input type="text" class="form-control" placeholder="Email" required="" name="email" value="{{ old('email') ? old('email') : ''}}">
                    </div>
                    <div>
                    ...
                    <div class="separator">
                        <div class="clearfix"></div>
                        <div>
                            <p>©2018 All Rights Reserved. <a href="http://www.jiatengfei.com" target="_blank">{{ $config['WEB_NAME'] }} </a></p>
                        </div>
                    </div>
                </form>
            </section>
