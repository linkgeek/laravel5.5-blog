...
Route::group(['namespace' => 'Home'], function () {
    ...
    //puamap
    Route::get('puamap', 'IndexController@puamap');
    //投稿
    Route::get('tougao', 'IndexController@tougao')->middleware('home.auth');
    //点赞
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'middleware' => 'admin.auth'], function () {
    ...
    Route::group(['prefix' => 'article'], function () {
        ...
        // 显示 隐藏
        Route::post('status', 'ArticleController@changeStatus');
    });
    ...
    Route::group(['prefix' => 'notice'], function(){
        ...
        // 显示 隐藏
        Route::any('status', 'NoticeController@changeStatus');
        // 编辑系统公告
