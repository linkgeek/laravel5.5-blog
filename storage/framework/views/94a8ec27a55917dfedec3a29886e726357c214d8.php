...
<?php $__env->startSection('content'); ?>
    ...
    <div id="b-tool" class="col-xs-12 col-md-12 col-lg-8">
    	<div class="row tool-default tool-web">
	        ...
	        <div class="col-xs-12">
	        	<img src="<?php echo e(asset('images/home/tool/vue.png')); ?>" alt="Node.js 中文网">
		        <a href="https://vuefe.cn/" class="" target="_blank">Vue.js 中文文档</a> 		         
		        <img src="<?php echo e(asset('images/home/tool/font-awesome.ico')); ?>" alt="Node.js 中文网">
		        <a href="http://fontawesome.dashgame.com/" target="_blank">Font Awesome</a> 
		        <img src="<?php echo e(asset('images/home/tool/iconfont.ico')); ?>" alt="Node.js 中文网">
        ...
        <div class="row tool-default tool-web">
	        ...
	        <div class="col-xs-12">
	        	<img src="<?php echo e(asset('images/home/tool/php.ico')); ?>" alt="PHP">
		...
		<div class="row tool-default tool-web">
	        ...
	        <div class="col-xs-12">
	        	<img src="<?php echo e(asset('images/home/tool/bootstrap.png')); ?>" alt="Node.js 中文网">
		        <a href="http://www.bootcss.com/" target="_blank">Bootstrap中文网</a> 
				<img src="<?php echo e(asset('images/home/tool/layui.jpg')); ?>" alt="Node.js 中文网">
		        ...
		        <img src="<?php echo e(asset('images/home/tool/thinkphp.png')); ?>" alt="ThinkPHP框架"> 
        ...
        <div class="row tool-default tool-web">
	        ...
	        <div class="col-xs-12">
	        	...
	        	<img src="<?php echo e(asset('images/home/tool/nodejs.png')); ?>" alt="API 文档 | Node.js 中文网">
		        <a href="http://nodejs.cn/api/" target="_blank">API 文档 | Node.js 中文网</a> 
		        <img src="<?php echo e(asset('images/home/tool/thinkphp.png')); ?>" alt="ThinkPHP5.1完全开发手册">
        ...
        <div class="row tool-default tool-web">
	        ...
	        <div class="col-xs-12 hidden-xs hidden-sm">
		        ...
		        <img src="<?php echo e(asset('images/home/tool/mysql.ico')); ?>" alt="MySQL">
		        <a href="https://dev.mysql.com/downloads/mysql/" target="_blank">MySQL</a>
				<img src="<?php echo e(asset('images/home/tool/apache.jpg')); ?>" alt="Apache">
		        <a href="http://httpd.apache.org/download.cgi" target="_blank">Apache</a>
		        <img src="<?php echo e(asset('images/home/tool/nginx.jpg')); ?>" alt="nginx">
        ...
        <div class="row tool-default tool-web">
	        ...
	        <div class="col-xs-12">
	        	<img src="<?php echo e(asset('images/home/tool/oschina.ico')); ?>" alt="Node.js 中文网">
		        <a href="http://tool.oschina.net/codeformat/json" target="_blank">在线代码格式化</a> 
		        <img src="<?php echo e(asset('images/home/tool/sojson.png')); ?>" alt="Node.js 中文网">
        ...
        <div class="row tool-default tool-web">
	        ...
	        <div class="col-xs-12">
		        <img src="<?php echo e(asset('images/home/tool/md5.jpg')); ?>" alt="md5在线解密破解,md5解密加密">
